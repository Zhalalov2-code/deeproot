...
export default function DynamicPage({ params }: { params: { slug: string } }) {
  ...
  if (serviceSlugs.includes(params.slug as ServiceSlug)) {
    ...
    const localizedService = siteContent.servicePages[slug];
  ...
  if (params.slug === "case-studies") return <CaseStudies />;
  if (params.slug === "about") return <About />;
  if (params.slug === "contact") return <Contact />;
  if (params.slug === "impressum" || params.slug === "datenschutz") return <Legal slug={params.slug} />;
